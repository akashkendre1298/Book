    ...
    <div className="min-h-[80vh] flex items-center justify-center">
      <div className="grid md:grid-cols-2 max-w-5xl w-full bg-paper border border-ink/20 shadow-2xl overflow-hidden min-h-[600px]">
        ...
        <div className="hidden md:flex flex-col justify-between p-12 border-r border-ink/20 bg-paper-darker relative overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <div className="mt-20">
              ...
              <p className="font-sans text-xs uppercase tracking-widest text-ink/50 mt-4">— Marcus Tullius Cicero</p>
            </div>
          </div>

          <div className="relative z-10 flex justify-between items-end">
            <span className="font-serif text-5xl text-ink/10 select-none">I / IV</span>
        ...
        <div className="flex flex-col justify-center p-12 lg:p-20">
          <div className="mb-12">
            <h1 className="text-4xl font-serif text-ink tracking-tight">Access the Archive</h1>
            <p className="font-sans text-sm text-ink/60 mt-2">Please identify yourself to continue.</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-8">
            ...
            <div className="pt-4 flex flex-col gap-6">
              ...
              <div className="flex justify-between items-center px-2">
                <Link to="/register" className="font-sans text-[10px] uppercase tracking-widest text-ink/40 hover:text-ink transition-colors">
                  Request Access
                </Link>
                <a href="#" className="font-sans text-[10px] uppercase tracking-widest text-ink/40 hover:text-ink transition-colors">
                  Forgot Key?
                </a>
              </div>
            </div>
