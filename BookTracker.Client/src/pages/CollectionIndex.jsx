  ...
  const fetchBooks = async () => {
    ...
    try {
      ...
      if (activeCategory === 'public') {
        console.log('--- Public Library Sync ---');
        console.log('Total volumes found:', response.data.length);
        console.log('Books with visibility == Public:', response.data.filter(b => b.visibility === 'Public' || b.visibility === 1));
      }
    } catch (err) {
      ...
      <section className="flex flex-col md:flex-row md:items-end justify-between gap-8 border-b border-ink/10 pb-12">
        <div className="space-y-6">
          <div className="space-y-2">
            ...
            <h1 className="text-6xl font-serif text-ink tracking-tighter leading-none">The Archive</h1>
          </div>
        ...
        <div className="flex flex-wrap items-center gap-4">
          <div className="relative group">
            ...
            <input
              ...
              className="bg-paper-darker border border-ink/10 px-10 py-3 font-sans text-sm outline-none focus:border-clay/30 transition-all w-[300px]"
              value={query}
          ...
          <button 
            ...
            className="bg-ink text-paper px-6 py-3 flex items-center gap-3 text-[10px] font-sans uppercase tracking-[0.2em] hover:bg-clay hover:text-ink transition-all shadow-lg"
          >
                      ...
                      <div className="flex gap-4 items-center">
                        {!book.isApproved && (
                          <button 
                            ...
                            disabled={book.moderationStatus === 'Pending'}
                          ...
                          >
                            {book.moderationStatus === 'Pending' ? 'Pending' : 'Request Public'}
                          </button>
                        )}
